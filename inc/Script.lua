...
if data.username_ then UserNameID = "📡┇معرفڪ ❪ @"..data.username_.." ❫\n" else UserNameID = "" end
...
'من وين انتهہ 😴',
'لمآ شوفڪ اذوب وربي 😍',
'ممڪن تشمر رصيد اسيا هون 😹',
'ممڪن خاص 😍💖',
'انتهہ ڪلبي يآروحي 😍',
'ڪولك ذوق 😹',
'تعآل حڪيلي عن دراستڪ 😹',
'آنته لو مو ابوڪ ڪنت تصير طيار 😹',
'منووور 😍😹',
'حبيتڪ يا روحي مح 😍',
'نورڪ ساطع بكروبنا 😍',
'شلون احبڪ وانتهہ مرتبط 😹💔',
'آنت مجنون والله ڪريم 😂',
'واو شو هآ الجمآل 😻',
'اسـلام اڪتب تعطيل الايدي فديتڪ 😢',
'هآد لي بحبوو 😍',
'آجى روحي 😍🙈',
...
return '👨🏾‍🔧┊ اصدار سورس سونيڪ : احـدث اصـدار \n📡'
end

if (MsgText[1] == '' or MsgText[1] == '™') then
if not msg.SudoBase then return "♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n❕" end
local GetVerison = https.request('https://github.com/zizo/zizo.github.io/GetVersion.txt') or 0
...
local inline = {{{text="⚜┇قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/Q2O10"}}}
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : زيزو](t.me/Q2O10)',nil,inline,msg.id_)
return false
end
...
return [[
❂┇܍اهـلآ بڪ في سورس  [زيزو] ❂┇

❂┇܍ آقوى سورس بدڪ السورس 10$ اسيآ 💰 2019 ❂┇
...
local NUM_MSG_maxsonik = (redis:get(boss..'num_msg_maxsonik'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_maxsonik) then 
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"👤¦ العضو » "..USERNAME.."\n🚸¦ قمـت بتگرآر آگثر مـن "..NUM_MSG_maxsonik.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
...
🎁¦ [اضغط هنا لديك مفاجئه](https://t.me/Q2O10)
🎁¦ [اضغط هنا لديك مفاجئه اخرى](https://t.me/Q2O10)
]] )
--=====================================
